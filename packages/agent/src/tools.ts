...
const RENDER_SCREEN_DESCRIPTION = [
  ...
  "naming the tool call the data came from. That id is the `toolCallId` field in the tool's",
  "own result — copy it exactly; it is not the tool's name. Tables and charts carry no data",
  "of their own: declare the columns or series you want and the portal fills them in from that call.",
